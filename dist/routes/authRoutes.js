...
var authRoutes = exports.authRoutes = function authRoutes(app, db) {
  // LOGIN
        ...
        while (1) switch (_context.p = _context.n) {
          ...
          case 1:
            ...
            if (user && user.password === password) {
              ...
              console.log("".concat(user.username, " logged in"));
            } else {
              res.status(401).json({
                success: false,
  ...
  app.post("/api/auth/signup", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, res) {
      var _req$body2, username, email, password, userId, result, _t2;
